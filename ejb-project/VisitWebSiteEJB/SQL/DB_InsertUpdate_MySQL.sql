...
delete from VIDEOS where CITY_ID = (SELECT ID FROM CITY WHERE NAME = 'Sydney');

UPDATE COUNTRY SET ISO='AU' WHERE NAME = 'Australia';
UPDATE COUNTRY SET ISO='FR' WHERE NAME = 'France';
UPDATE COUNTRY SET ISO='IE' WHERE NAME = 'Ireland';
UPDATE COUNTRY SET ISO='US' WHERE NAME = 'USA';
UPDATE COUNTRY SET ISO='GB' WHERE NAME = 'United Kingdom';
...
CREATE INDEX ARTICLE_PART_TITLE_IDX ON ARTICLE_PART(TITLE);
...
INSERT INTO USERS (LOGIN, PASSWORD, IS_ADMIN)
	...
	delete from ARTICLE_PART where ARTICLE_ID > 1;
	delete from ARTICLE where ID > 1;
	select * from ARTICLE_PART;